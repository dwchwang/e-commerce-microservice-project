...
| 14 - Admin Panel | Admin Panel Next.js da trien khai trong cung frontend, co ROLE_ADMIN guard va cac module dashboard/products/inventory/orders/users/vouchers/flash-sales/content/reviews | `.codex/plan/phase-14-admin-panel.md`, `.docs/09-admin-panel.md`, `frontend/app/(admin)/` |
...
- Cac bang chung runtime/demo nen gan voi artifact, screenshot hoac source code cu the; khong ghi qua muc production multi-node.
...
5. Dua cac han che trung thuc: single-host, chua Kubernetes/autoscaling/service mesh, chua schema registry/contract test day du, chua mobile app rieng va payment production.
