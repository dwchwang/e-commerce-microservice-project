...
| File | Nội dung |
|------|---------|
| [16-chay-end-to-end.md](16-chay-end-to-end.md) | **Chạy E2E backend + frontend + admin** — seed dữ liệu, gán ROLE_ADMIN, kịch bản từng luồng (đăng nhập, giỏ hàng, COD/VNPAY, flash sale, review, admin), checklist |
| [17-huong-dan-final-van-hanh-du-an.md](17-huong-dan-final-van-hanh-du-an.md) | **Hướng dẫn final sau 14 phase** — chạy production EC2, frontend/admin, Grafana, Prometheus, Zipkin, Kafka/DB, Phase 13 metrics, CI/CD, stop/start |
| [18-demo-thu-cong-hoi-dong.md](18-demo-thu-cong-hoi-dong.md) | **Hướng dẫn chạy thủ công và đi sâu hệ thống** — mở Eureka, Config Server, Gateway, Keycloak, Grafana, Prometheus, Zipkin, Kafka, DB, Redis, Elasticsearch và các luồng frontend/admin |
...
| URL | Mục đích |
|-----|---------|
| http://localhost:3000 | Frontend storefront + Admin Panel (`npm run dev`) |
| http://localhost:3000/admin | Admin Panel (cần ROLE_ADMIN) |
...
| http://localhost:3000 | Grafana Dashboard *(xung đột cổng với FE — xem guide 16)* |
